...
class Mungbikri extends React.Component {
 
  async createmungbikri() {
    try {
      ...
      this.setState({addingbikricreatemungbikri:false})
    
      if ((bhavup==0)) {
        this.setState({addingbikricreatemungbikri:true})
...
var year = new Date().getFullYear().toLocaleString();
      ...
      firebase
    .database()
    .ref('mungbikricreatemungbikri').push()
    .set({
      ...
      bikricreatemungbikri:'bikricreatemungbikri',
    });
setTimeout(()=>{this.setState({addingbikricreatemungbikri:true})},300)
  ...
  state = {
    idtoset:0,
    addingbikricreatemungbikri:true,
    vajan: 0,
    bhav: 1,
    vikretakanaam: "",
    kulrashi: 0,
  ...
  render() {
    ...
    starCountRef.on('value', (snapshot) => {
      ...
      this.setState({ bhav:data.mung.mung});
    ...
    return (
      ...
      <ScrollView>
      {this.state.addingbikricreatemungbikri?
        <View>
          ...
          <View style={{ flexDirection: "row" }}>
            ...
            >
              <TouchableOpacity
                ...
                onPress={this.createmungbikri.bind(this)}
              >
                <Text
                  style={{
                    textAlign: "center",
