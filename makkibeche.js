...
class Makkibikri extends React.Component {
 
  async createmakkibikri() {
    try {
      ...
      this.setState({addingbikricreatemakkibikri:false})
    
      if ((bhavup==0)) {
        this.setState({addingbikricreatemakkibikri:true})
...
var year = new Date().getFullYear().toLocaleString();
      ...
      firebase
    .database()
    .ref('makkibikricreatemakkibikri').push()
    .set({
      ...
      bikricreatemakkibikri:'bikricreatemakkibikri',
    });
setTimeout(()=>{this.setState({addingbikricreatemakkibikri:true})},300)
  ...
  state = {
    idtoset:0,
    addingbikricreatemakkibikri:true,
    vajan: 0,
    bhav: 1,
    vikretakanaam: "",
    kulrashi: 0,
  ...
  render() {
    ...
    starCountRef.on('value', (snapshot) => {
      ...
      this.setState({ bhav:data.makki.makki});
    ...
    return (
      ...
      <ScrollView>
      {this.state.addingbikricreatemakkibikri?
        <View>
          ...
          <View style={{ flexDirection: "row" }}>
            ...
            >
              <TouchableOpacity
                ...
                onPress={this.createmakkibikri.bind(this)}
              >
                <Text
                  style={{
                    textAlign: "center",
