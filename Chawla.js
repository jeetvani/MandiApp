...
class Chawla extends React.Component {
 
  async createchawlakharidi() {
    try {
...
setTimeout(()=>{this.setState({addingkharidi:true})},2000)
  ...
  render() {
    ...
    starCountRef.on('value', (snapshot) => {
      ...
      this.setState({ bhav:data.chawla.chawla});
          ...
          <View style={{ flexDirection: "row" }}>
            ...
            >
              <TouchableOpacity
                ...
                onPress={this.createchawlakharidi.bind(this)}
              >
                <Text
                  style={{
                    textAlign: "center",
