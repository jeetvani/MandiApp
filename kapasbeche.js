...
class Kapasbikri extends React.Component {
 
  async createkapasbikri() {
    try {
      ...
      this.setState({addingbikricreatekapasbikri:false})
    
      if ((bhavup==0)) {
        this.setState({addingbikricreatekapasbikri:true})
...
var year = new Date().getFullYear().toLocaleString();
      ...
      firebase
    .database()
    .ref('kapasbikricreatekapasbikri').push()
    .set({
      ...
      bikricreatekapasbikri:'bikricreatekapasbikri',
    });
setTimeout(()=>{this.setState({addingbikricreatekapasbikri:true})},300)
  ...
  state = {
    idtoset:0,
    addingbikricreatekapasbikri:true,
    vajan: 0,
    bhav: 1,
    vikretakanaam: "",
    kulrashi: 0,
  ...
  render() {
    ...
    starCountRef.on('value', (snapshot) => {
      ...
      this.setState({ bhav:data.kapas.kapas});
    ...
    return (
      ...
      <ScrollView>
      {this.state.addingbikricreatekapasbikri?
        <View>
          ...
          <View style={{ flexDirection: "row" }}>
            ...
            >
              <TouchableOpacity
                ...
                onPress={this.createkapasbikri.bind(this)}
              >
                <Text
                  style={{
                    textAlign: "center",
