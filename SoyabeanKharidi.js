...
class SoyabeanKharidi extends React.Component {
  arr = [];

  async getsoyabeankharidi() {
    try {
      const myitems = firebase.database().ref("soyabeanKharidi");
  ...
  componentDidMount() {
    setTimeout(this.getsoyabeankharidi.bind(this), 1000);
  }
  render() {
    return (
      <View>
...
export default SoyabeanKharidi;
