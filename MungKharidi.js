...
class MungKharidi extends React.Component {
  arr = [];

  async getmungkharidi() {
    try {
      const myitems = firebase.database().ref("mungKharidi");
  ...
  componentDidMount() {
    setTimeout(this.getmungkharidi.bind(this), 1000);
  }
  render() {
    return (
      <View>
