...
class GehuKharidi extends React.Component {
  arr = [];

  async getgehukharidi() {
    try {
      const myitems = firebase.database().ref("gehuKharidi");
  ...
  componentDidMount() {
    setTimeout(this.getgehukharidi.bind(this), 1000);
  }
  render() {
    return (
      <View>
