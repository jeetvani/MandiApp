...
class KapasKharidi extends React.Component {
  arr = [];

  async getkapaskharidi() {
    try {
      const myitems = firebase.database().ref("kapasKharidi");
  ...
  componentDidMount() {
    setTimeout(this.getkapaskharidi.bind(this), 1000);
  }
  render() {
    return (
      <View>
