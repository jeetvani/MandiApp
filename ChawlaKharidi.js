...
class ChawlaKharidi extends React.Component {
  arr = [];

  async getchawlakharidi() {
    try {
      const myitems = firebase.database().ref("chawlaKharidi");
  ...
  componentDidMount() {
    setTimeout(this.getchawlakharidi.bind(this), 1000);
  }
  render() {
    return (
      <View>
