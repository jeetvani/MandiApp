...
class Gehubikri extends React.Component {
 
  async creategehubikri() {
    try {
      ...
      this.setState({addingbikricreategehubikri:false})
    
      if ((bhavup==0)) {
        this.setState({addingbikricreategehubikri:true})
...
var year = new Date().getFullYear().toLocaleString();
      ...
      firebase
    .database()
    .ref('gehubikricreategehubikri').push()
    .set({
      ...
      bikricreategehubikri:'bikricreategehubikri',
    });
setTimeout(()=>{this.setState({addingbikricreategehubikri:true})},300)
  ...
  state = {
    idtoset:0,
    addingbikricreategehubikri:true,
    vajan: 0,
    bhav: 1,
    vikretakanaam: "",
    kulrashi: 0,
  ...
  render() {
    ...
    starCountRef.on('value', (snapshot) => {
      ...
      this.setState({ bhav:data.gehu.gehu});
    ...
    return (
      ...
      <ScrollView>
      {this.state.addingbikricreategehubikri?
        <View>
          ...
          <View style={{ flexDirection: "row" }}>
            ...
            >
              <TouchableOpacity
                ...
                onPress={this.creategehubikri.bind(this)}
              >
                <Text
                  style={{
                    textAlign: "center",
