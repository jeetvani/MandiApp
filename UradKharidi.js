...
class UradKharidi extends React.Component {
  arr = [];

  async geturadkharidi() {
    try {
      const myitems = firebase.database().ref("uradKharidi");
  ...
  componentDidMount() {
    setTimeout(this.geturadkharidi.bind(this), 1000);
  }
  render() {
    return (
      <View>
