...
class BajraKharidi extends React.Component {
  arr = [];

  async getbajrakharidi() {
    try {
      const myitems = firebase.database().ref("bajraKharidi");
  ...
  componentDidMount() {
    setTimeout(this.getbajrakharidi.bind(this), 1000);
  }
  render() {
    return (
      <View>
