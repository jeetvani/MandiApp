...
class Soyabeanbikri extends React.Component {
 
  async createsoyabeanbikri() {
    try {
      ...
      this.setState({addingbikricreatesoyabeanbikri:false})
    
      if ((bhavup==0)) {
        this.setState({addingbikricreatesoyabeanbikri:true})
...
var year = new Date().getFullYear().toLocaleString();
      ...
      firebase
    .database()
    .ref('soyabeanbikricreatesoyabeanbikri').push()
    .set({
      ...
      bikricreatesoyabeanbikri:'bikricreatesoyabeanbikri',
    });
setTimeout(()=>{this.setState({addingbikricreatesoyabeanbikri:true})},300)
  ...
  state = {
    idtoset:0,
    addingbikricreatesoyabeanbikri:true,
    vajan: 0,
    bhav: 1,
    vikretakanaam: "",
    kulrashi: 0,
  ...
  render() {
    ...
    starCountRef.on('value', (snapshot) => {
      ...
      this.setState({ bhav:data.soyabean.soyabean});
    ...
    return (
      ...
      <ScrollView>
      {this.state.addingbikricreatesoyabeanbikri?
        <View>
          ...
          <View style={{ flexDirection: "row" }}>
            ...
            >
              <TouchableOpacity
                ...
                onPress={this.createsoyabeanbikri.bind(this)}
              >
                <Text
                  style={{
                    textAlign: "center",
