...
class JawarKharidi extends React.Component {
  arr = [];

  async getjawarkharidi() {
    try {
      const myitems = firebase.database().ref("jawarKharidi");
  ...
  componentDidMount() {
    setTimeout(this.getjawarkharidi.bind(this), 1000);
  }
  render() {
    return (
      <View>
