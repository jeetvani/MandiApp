...
class Urad extends React.Component {
 
  async createuradkharidi() {
    try {
...
setTimeout(()=>{this.setState({addingkharidi:true})},300)
  ...
  render() {
    ...
    starCountRef.on('value', (snapshot) => {
      ...
      this.setState({ bhav:data.urad.urad});
          ...
          <View style={{ flexDirection: "row" }}>
            ...
            >
              <TouchableOpacity
                ...
                onPress={this.createuradkharidi.bind(this)}
              >
                <Text
                  style={{
                    textAlign: "center",
