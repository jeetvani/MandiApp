...
class TuarKharidi extends React.Component {
  arr = [];

  async gettuarkharidi() {
    try {
      const myitems = firebase.database().ref("tuarKharidi");
  ...
  componentDidMount() {
    setTimeout(this.gettuarkharidi.bind(this), 1000);
  }
  render() {
    return (
      <View>
