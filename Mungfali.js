...
class Mungfali extends React.Component {
 
  async createmungfalikharidi() {
    try {
          ...
          <View style={{ flexDirection: "row" }}>
            ...
            >
              <TouchableOpacity
                ...
                onPress={this.createmungfalikharidi.bind(this)}
              >
                <Text
                  style={{
                    textAlign: "center",
