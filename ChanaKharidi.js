...
class ChanaKharidi extends React.Component {
  arr = [];

  async getchanakharidi() {
    try {
      const myitems = firebase.database().ref("chanaKharidi");
  ...
  componentDidMount() {
    setTimeout(this.getchanakharidi.bind(this), 1000);
  }
  render() {
    return (
      <View>
