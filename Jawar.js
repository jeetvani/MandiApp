...
class Jawar extends React.Component {
 
  async createjawarkharidi() {
    try {
...
setTimeout(()=>{this.setState({addingkharidi:true})},300)
  ...
  render() {
    ...
    starCountRef.on('value', (snapshot) => {
      ...
      this.setState({ bhav:data.jawar.jawar});
          ...
          <View style={{ flexDirection: "row" }}>
            ...
            >
              <TouchableOpacity
                ...
                onPress={this.createjawarkharidi.bind(this)}
              >
                <Text
                  style={{
                    textAlign: "center",
